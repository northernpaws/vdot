...
CubismRenderer::CubismRenderer( CubismModel *owner_viewport, godot::Node *parent_node ) :
    ...
    this->ary_shader[CUBISM_SHADER_NORM_ADD] =
        res_loader->load( "res://addons/vdot/assets/live2d/shader/2d_cubism_norm_add.gdshader" );
    this->ary_shader[CUBISM_SHADER_NORM_MIX] =
        res_loader->load( "res://addons/vdot/assets/live2d/shader/2d_cubism_norm_mix.gdshader" );
    this->ary_shader[CUBISM_SHADER_NORM_MUL] =
        res_loader->load( "res://addons/vdot/assets/live2d/shader/2d_cubism_norm_mul.gdshader" );

    this->ary_shader[CUBISM_SHADER_MASK] =
        res_loader->load( "res://addons/vdot/assets/live2d/shader/2d_cubism_mask.gdshader" );
