...
godot::PackedInt32Array make_PackedArrayInt32(const Live2D::Cubism::Framework::csmUint16 *ptr, const int32_t &size);
godot::PackedVector2Array make_PackedArrayVector2(const Live2D::Cubism::Core::csmVector2 *ptr, const int32_t &size);
godot::PackedVector2Array make_PackedArrayVector3(const Live2D::Cubism::Core::csmVector2 *ptr, const int32_t &size, const Csm::csmFloat32 &ppunit, const godot::Vector2 &vct_adjust);
...
godot::Ref<godot::ShaderMaterial> CubismRenderer2D::make_ShaderMaterial(const Csm::CubismModel *model, const Csm::csmInt32 index, const ::CubismRenderer &res) const
{
    ...
    mat->set_shader_parameter("color_base", godot::Vector4(color_base.R, color_base.G, color_base.B, color_base.A));
...
void CubismRenderer2D::update_mask(godot::SubViewport *viewport, const Csm::csmInt32 index, ::CubismRenderer &res)
{
