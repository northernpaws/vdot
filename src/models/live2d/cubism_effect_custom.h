...
class CubismEffectCustom : public CubismEffect {
  ...
  protected:
    static void _bind_methods() {
        ADD_SIGNAL( godot::MethodInfo( "cubism_init",
                                       godot::PropertyInfo( godot::Variant::OBJECT, "model",
                                                            godot::PROPERTY_HINT_RESOURCE_TYPE,
                                                            "GDCubismUserModel" ) ) );
        ADD_SIGNAL( godot::MethodInfo( "cubism_term",
                                       godot::PropertyInfo( godot::Variant::OBJECT, "model",
                                                            godot::PROPERTY_HINT_RESOURCE_TYPE,
                                                            "GDCubismUserModel" ) ) );

        ADD_SIGNAL( godot::MethodInfo( "cubism_prologue",
                                       godot::PropertyInfo( godot::Variant::OBJECT, "model",
                                                            godot::PROPERTY_HINT_RESOURCE_TYPE,
                                                            "GDCubismUserModel" ),
                                       godot::PropertyInfo( godot::Variant::FLOAT, "delta" ) ) );
        ADD_SIGNAL( godot::MethodInfo( "cubism_process",
                                       godot::PropertyInfo( godot::Variant::OBJECT, "model",
                                                            godot::PROPERTY_HINT_RESOURCE_TYPE,
                                                            "GDCubismUserModel" ),
                                       godot::PropertyInfo( godot::Variant::FLOAT, "delta" ) ) );
        ADD_SIGNAL( godot::MethodInfo( "cubism_epilogue",
                                       godot::PropertyInfo( godot::Variant::OBJECT, "model",
                                                            godot::PROPERTY_HINT_RESOURCE_TYPE,
                                                            "GDCubismUserModel" ),
                                       godot::PropertyInfo( godot::Variant::FLOAT, "delta" ) ) );
