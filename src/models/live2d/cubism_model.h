...
public:
    ...
    void set_adjust_position(const godot::Vector2 pos) { this->adjust_pos = pos; }
    godot::Vector2 get_adjust_position() const { return this->adjust_pos; }

    void set_mask_viewport_size(const godot::Vector2i size) { this->mask_viewport_size = size; }
    godot::Vector2i get_mask_viewport_size() const { return this->mask_viewport_size; }

    godot::Dictionary get_motions() const;
    godot::Ref<CubismMotionQueueEntryHandle> start_motion(const godot::String str_group, const int32_t no, const Priority priority);
    godot::Ref<CubismMotionQueueEntryHandle> start_motion_loop(const godot::String str_group, const int32_t no, const Priority priority, const bool loop, const bool loop_fade_in);
    ...
    void set_shader(const CubismShader e, godot::Ref<godot::Shader> shader) { this->ary_shader[e] = shader; }
    godot::Ref<godot::Shader> get_shader(const CubismShader e) const { return this->ary_shader[e]; }

    // NormAdd
    void set_shader_add(godot::Ref<godot::Shader> shader) { this->set_shader(CUBISM_SHADER_NORM_ADD, shader); }
    godot::Ref<godot::Shader> get_shader_add() const { return this->get_shader(CUBISM_SHADER_NORM_ADD); }

    // NormMix
    void set_shader_mix(godot::Ref<godot::Shader> shader) { this->set_shader(CUBISM_SHADER_NORM_MIX, shader); }
    godot::Ref<godot::Shader> get_shader_mix() const { return this->get_shader(CUBISM_SHADER_NORM_MIX); }

    // NormMul
    void set_shader_mul(godot::Ref<godot::Shader> shader) { this->set_shader(CUBISM_SHADER_NORM_MUL, shader); }
    godot::Ref<godot::Shader> get_shader_mul() const { return this->get_shader(CUBISM_SHADER_NORM_MUL); }

    // Mask
    void set_shader_mask(godot::Ref<godot::Shader> shader) { this->set_shader(CUBISM_SHADER_MASK, shader); }
    godot::Ref<godot::Shader> get_shader_mask() const { return this->get_shader(CUBISM_SHADER_MASK); }

    // MaskAdd
    void set_shader_mask_add(godot::Ref<godot::Shader> shader) { this->set_shader(CUBISM_SHADER_MASK_ADD, shader); }
    godot::Ref<godot::Shader> get_shader_mask_add() const { return this->get_shader(CUBISM_SHADER_MASK_ADD); }
    void set_shader_mask_add_inv(godot::Ref<godot::Shader> shader) { this->set_shader(CUBISM_SHADER_MASK_ADD_INV, shader); }
    godot::Ref<godot::Shader> get_shader_mask_add_inv() const { return this->get_shader(CUBISM_SHADER_MASK_ADD_INV); }

    // MaskMix
    void set_shader_mask_mix(godot::Ref<godot::Shader> shader) { this->set_shader(CUBISM_SHADER_MASK_MIX, shader); }
    godot::Ref<godot::Shader> get_shader_mask_mix() const { return this->get_shader(CUBISM_SHADER_MASK_MIX); }
    void set_shader_mask_mix_inv(godot::Ref<godot::Shader> shader) { this->set_shader(CUBISM_SHADER_MASK_MIX_INV, shader); }
    godot::Ref<godot::Shader> get_shader_mask_mix_inv() const { return this->get_shader(CUBISM_SHADER_MASK_MIX_INV); }

    // MaskMul
    void set_shader_mask_mul(godot::Ref<godot::Shader> shader) { this->set_shader(CUBISM_SHADER_MASK_MUL, shader); }
    godot::Ref<godot::Shader> get_shader_mask_mul() const { return this->get_shader(CUBISM_SHADER_MASK_MUL); }
    void set_shader_mask_mul_inv(godot::Ref<godot::Shader> shader) { this->set_shader(CUBISM_SHADER_MASK_MUL_INV, shader); }
    godot::Ref<godot::Shader> get_shader_mask_mul_inv() const { return this->get_shader(CUBISM_SHADER_MASK_MUL_INV); }
