...
class CubismParameter : public CubismValueAbs {
  ...
  protected:
    static void _bind_methods() {
        ...
        godot::ClassDB::bind_method( godot::D_METHOD( "get_minimum_value" ),
                                     &CubismParameter::get_minimum_value );
        ADD_PROPERTY( godot::PropertyInfo( godot::Variant::FLOAT, "minimum_value" ),
                      godot::String(), "get_minimum_value" );
        godot::ClassDB::bind_method( godot::D_METHOD( "get_maximum_value" ),
                                     &CubismParameter::get_maximum_value );
        ADD_PROPERTY( godot::PropertyInfo( godot::Variant::FLOAT, "maximum_value" ),
                      godot::String(), "get_maximum_value" );
        godot::ClassDB::bind_method( godot::D_METHOD( "get_default_value" ),
                                     &CubismParameter::get_default_value );
        ADD_PROPERTY( godot::PropertyInfo( godot::Variant::FLOAT, "default_value" ),
                      godot::String(), "get_default_value" );
  ...
  private:
    void setup( Csm::CubismModel *model, Csm::csmInt32 index ) override {
        ...
        this->type =
            static_cast<Type>( Live2D::Cubism::Core::csmGetParameterTypes( csm_model )[index] );
        this->minimum_value =
  ...
  public:
    ...
    void set_hold( const bool value ) {
        this->hold = value;
    }
    bool get_hold() const {
        return this->hold;
