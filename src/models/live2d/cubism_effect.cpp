...
void CubismEffect::_bind_methods() {
    godot::ClassDB::bind_method(godot::D_METHOD("set_active", "value"), &CubismEffect::set_active);
    godot::ClassDB::bind_method(godot::D_METHOD("get_active"), &CubismEffect::get_active);
    ADD_PROPERTY(godot::PropertyInfo(godot::Variant::BOOL, "active"), "set_active", "get_active");
}
