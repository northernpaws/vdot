...
void AvatarType::_bind_methods() {
    ...
    godot::ClassDB::bind_method(
        godot::D_METHOD( "set_avatar_type_description", "avatar_type_description" ),
...
void AvatarManager::_bind_methods() {
    ...
    ADD_PROPERTY( godot::PropertyInfo(
                      godot::Variant::ARRAY, "avatar_types", godot::PROPERTY_HINT_TYPE_STRING,
                      godot::String::num( godot::Variant::OBJECT ) + "/" +
                          godot::String::num( godot::PROPERTY_HINT_RESOURCE_TYPE ) + ":" +
                          AvatarType::get_class_static() ),
