...
const godot::Array LiveLinkClientData::key_map = godot::Array::make(
    ...
    godot::StringName( "blend_shapes/jawForward" ), godot::StringName( "blend_shapes/jawRight" ),
    godot::StringName( "blend_shapes/jawLeft" ), godot::StringName( "blend_shapes/jawOpen" ),
    godot::StringName( "blend_shapes/mouthClose" ), godot::StringName( "blend_shapes/mouthFunnel" ),
    godot::StringName( "blend_shapes/mouthPucker" ), godot::StringName( "blend_shapes/mouthRight" ),
    ...
    godot::StringName( "blend_shapes/tongueOut" ), godot::StringName( "blend_shapes/headYaw" ),
    godot::StringName( "blend_shapes/headPitch" ), godot::StringName( "blend_shapes/headRoll" ),
