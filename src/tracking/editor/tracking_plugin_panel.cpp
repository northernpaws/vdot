...

    {
...

        {
...

            {
                ...
                _interface_list->connect( "item_selected",
                                          godot::Callable( this, "_on_interface_selected" ) );
...

            {
                ...
                _tracker_list->connect( "item_selected",
                                        godot::Callable( this, "_on_tracker_selected" ) );
